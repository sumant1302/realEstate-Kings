...
<?php
        ...
        $sql="SELECT PropertyID,UserID, Iam,Name,Mobile,Email,PropertyFor,PropertyType,City,Locality,Images,RSK_exclusivity,UploadTime FROM listproperty WHERE PropertyID='$propertyID'";
...
// Get the navbar
var navbar = document.getElementById("view-buttons");
