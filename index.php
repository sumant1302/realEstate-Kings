...
<body>
	...
	<div class="home-inline" style="width: 100%; display: inline-flex; align-items: center; justify-content: center; margin: 0;">
		<div class="home-view" style="max-width: 1250px; background-color: white; height: 100%; margin: 0;">
			...
			<div class="home-featured" style="padding: 1%;">
				<p>
				<h2>Featured <b>Collections</b></h2>
				</p>
	...
	<style>
		...
		div.contact-seller-form input[type=text],
		div.contact-seller-form input[type=tel],
		div.contact-seller-form input[type=email],
		div.contact-seller-form textarea {
			width: 90%;
			border: none;
			border-bottom: 1px solid rgb(1, 1, 1);
			margin: 1.5% 0;
	...
	<div class="website-records" style="background-color: cyan;">
		<div>
			<p>
			<h3>Total Number of Visits on the Site:</h3><i> 2,21,025</i></p>
		</div>
		<div>
			<p>
			<h3>Total Number of Properties Listed:</h3><i>2,025</i></p>
		</div>
	</div>
	<style>
		div.website-records {
