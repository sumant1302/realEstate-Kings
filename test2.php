...
<div class="page-no" style="margin:10px;">
  ...
  <?php
        $sql="SELECT PropertyID,UserID, Iam,Name,Mobile,Email,PropertyFor,PropertyType,City,Locality,Images,RSK_exclusivity,UploadTime FROM listproperty LIMIT 10";
...
<?php
    $get_details="SELECT `PropTitle`, `PropPrice`, `BuildupArea`, `Configuration`, `PosessionStatus`, `Facing`, `CarpetArea`, `Bathrooms`, `Balcony`, `Bedrooms`, `Parking`, `About`, `UpdatedTime`
     FROM property_details WHERE PropertyID=?";
